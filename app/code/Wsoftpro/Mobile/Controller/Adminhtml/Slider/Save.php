...
namespace Wsoftpro\Mobile\Controller\Adminhtml\Slider;
 ...
 */
class Save extends \WeltPixel\OwlCarouselSlider\Controller\Adminhtml\Slider\Save
{
    /**
     * Dispatch request
     *
    ...
    public function execute()
    {
        ...
        if (isset($formPostValues['slider'])) {
            ...
            $sliderModel->addData($sliderData['slider']);
